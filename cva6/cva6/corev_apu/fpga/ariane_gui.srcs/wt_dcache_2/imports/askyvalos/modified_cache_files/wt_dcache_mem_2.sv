...
module wt_dcache_mem_2 import ariane_pkg2::*; import wt_cache_pkg2::*; #(
...
///////////////////////////////////////////////////////
  ...
  for (genvar k = 0; k < DCACHE_NUM_BANKS; k++) begin : gen_data_banks
    // Data RAM
    sram #(
      .USER_WIDTH ( ariane_pkg2::DCACHE_SET_ASSOC * DATA_USER_WIDTH ),
      .DATA_WIDTH ( ariane_pkg2::DCACHE_SET_ASSOC * riscv::XLEN ),
      .USER_EN    ( ariane_pkg2::DATA_USER_EN          ),
      .NUM_WORDS  ( wt_cache_pkg2::DCACHE_NUM_WORDS    )
    ) i_data_sram (
      .clk_i      ( clk_i               ),
      .rst_ni     ( rst_ni              ),
      .req_i      ( bank_req   [k]      ),
  ...
  for (genvar i = 0; i < DCACHE_SET_ASSOC; i++) begin : gen_tag_srams
    ...
    sram #(
      // tag + valid bit
      .DATA_WIDTH ( ariane_pkg2::DCACHE_TAG_WIDTH + 1 ),
      .NUM_WORDS  ( wt_cache_pkg2::DCACHE_NUM_WORDS   )
    ) i_tag_sram (
      .clk_i     ( clk_i               ),
      .rst_ni    ( rst_ni              ),
...
`ifndef VERILATOR
  ...
  logic                                    vld_mirror[wt_cache_pkg2::DCACHE_NUM_WORDS-1:0][ariane_pkg2::DCACHE_SET_ASSOC-1:0];
  logic [ariane_pkg2::DCACHE_TAG_WIDTH-1:0] tag_mirror[wt_cache_pkg2::DCACHE_NUM_WORDS-1:0][ariane_pkg2::DCACHE_SET_ASSOC-1:0];
  logic [ariane_pkg2::DCACHE_SET_ASSOC-1:0] tag_write_duplicate_test;
