...
module wt_dcache_wbuffer_2 import ariane_pkg2::*; import wt_cache_pkg2::*; #(
  parameter ariane_pkg2::ariane_cfg_t    ArianeCfg          = ariane_pkg2::ArianeDefaultConfig     // contains cacheable regions
) (
...
// misc
///////////////////////////////////////////////////////
  logic [ariane_pkg2::DCACHE_TAG_WIDTH-1:0] miss_tag;
  logic is_nc_miss;
  logic is_ni;
  assign miss_tag = miss_paddr_o[ariane_pkg2::DCACHE_INDEX_WIDTH+:ariane_pkg2::DCACHE_TAG_WIDTH];
  assign is_nc_miss = !ariane_pkg2::is_inside_cacheable_regions(ArianeCfg, {{64-DCACHE_TAG_WIDTH-DCACHE_INDEX_WIDTH{1'b0}}, miss_tag, {DCACHE_INDEX_WIDTH{1'b0}}});
  assign miss_nc_o = !cache_en_i || is_nc_miss;
  // Non-idempotent if request goes to NI region
  assign is_ni = ariane_pkg2::is_inside_nonidempotent_regions(ArianeCfg, {{64-DCACHE_TAG_WIDTH-DCACHE_INDEX_WIDTH{1'b0}}, req_port_i.address_tag, {DCACHE_INDEX_WIDTH{1'b0}}});
...
///////////////////////////////////////////////////////
  ...
  if (ariane_pkg2::DATA_USER_EN) begin
