...
module wt_dcache_missunit_2 import ariane_pkg2::*; import wt_cache_pkg2::*; #(
...
///////////////////////////////////////////////////////
  ...
  assign flush_done      = (cnt_q == wt_cache_pkg2::DCACHE_NUM_WORDS-1);
...
///////////////////////////////////////////////////////
  ...
  lzc #(
    .WIDTH ( ariane_pkg2::DCACHE_SET_ASSOC )
  ) i_lzc_inv (
  ...
  lfsr #(
    .LfsrWidth  ( 8        ),
    .OutWidth   ( $clog2(ariane_pkg2::DCACHE_SET_ASSOC))
  ) i_lfsr_inv (
    .clk_i          ( clk_i       ),
    .rst_ni         ( rst_ni      ),
    .en_i           ( update_lfsr ),
...
///////////////////////////////////////////////////////
  ...
  assign mem_data_o.paddr  = wt_cache_pkg2::paddrSizeAlign(tmp_paddr, mem_data_o.size);
...
///////////////////////////////////////////////////////
  ...
  logic store_sent;
  logic [$clog2(wt_cache_pkg2::DCACHE_MAX_TX + 1)-1:0] stores_inflight_d, stores_inflight_q;
