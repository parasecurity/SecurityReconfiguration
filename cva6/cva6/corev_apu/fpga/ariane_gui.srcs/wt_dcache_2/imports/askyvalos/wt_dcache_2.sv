...
module wt_dcache_2 import ariane_pkg2::*; import wt_cache_pkg2::*; #(
  ...
  parameter ariane_pkg2::ariane_cfg_t     ArianeCfg          = ariane_pkg2::ArianeDefaultConfig   
) (
  ...
  input  ariane_pkg2::amo_t              amo_req_i_amo_op,
...
//  output logic [DCACHE_SET_ASSOC-1:0]    miss_vld_bits_o_3,
  ...
  input  wt_cache_pkg2::dcache_in_t                       mem_rtrn_i_rtype,       // see definitions above
  input  logic [ariane_pkg2::DCACHE_LINE_WIDTH-1:0]       mem_rtrn_i_data,        // full cache line width
  input  logic [ariane_pkg2::DCACHE_USER_LINE_WIDTH-1:0]  mem_rtrn_i_user,        // user bits
  input  logic                                            mem_rtrn_i_inv_vld,
  input  logic                                            mem_rtrn_i_inv_all,
  input  logic [ariane_pkg2::DCACHE_INDEX_WIDTH-1:0]      mem_rtrn_i_inv_idx,
//  input  logic [L15_WAY_WIDTH-1:0]                        mem_rtrn_i_inv_way,
  ...
  output wt_cache_pkg2::dcache_out_t                      mem_data_o_rtype,       // see definitions above
...
//  output logic [L1D_WAY_WIDTH-1:0]                        mem_data_o_way,         // way to replace
  ...
  output logic [ariane_pkg2::DATA_USER_WIDTH-1:0]         mem_data_o_user,        // user width of processor (no block stores at the moment)
  ...
  output ariane_pkg2::amo_t                               mem_data_o_amo_op,      // amo opcode
  
  output logic [7:0]                    led_tests
);

  assign led_tests = 8'b01100110;
...
//  assign miss_vld_bits_o_3 = miss_vld_bits_o[2];
  //struct declaration
  ariane_pkg2::amo_req_t amo_req_i;
  ariane_pkg2::amo_resp_t amo_resp_o;
  ...
  ariane_pkg2::dcache_req_i_t[2:0] req_ports_i;
  ...
  ariane_pkg2::dcache_req_o_t[2:0]   req_ports_o;
  ...
  wt_cache_pkg2::dcache_rtrn_t  mem_rtrn_i;
  ...
  wt_cache_pkg2::dcache_req_t  mem_data_o;         
...
///////////////////////////////////////////////////////
  ...
  wt_dcache_missunit_2 #(
    .AxiCompliant ( ArianeCfg.AxiCompliant ),
    .AmoTxId      ( RdAmoTxId              ),
    .NumPorts     ( NumPorts               ),
    .AxiDataWidth ( AxiDataWidth           )
  ) i_wt_dcache_missunit_2 (
    .clk_i              ( clk_i              ),
    .rst_ni             ( rst_ni             ),
    .enable_i           ( enable_i           ),
    .flush_i            ( flush_i            ),
