...
int gpt_find_boot_partition(uint8_t* dest, uint32_t size)
{
    ...
    partition_entries_t *pbit1 = (partition_entries_t *)(lba2_buf+256);
    print_uart("\r\ncopying partial bitstream 1 to 0x95000000 ");
    res = sd_copy((uint8_t *)0x95000000UL, pbit1->first_lba, pbit1->last_lba - pbit1->first_lba + 1);
    ...
    partition_entries_t *pbit2 = (partition_entries_t *)(lba2_buf+256+128);
    print_uart("\r\ncopying partial bitstream 2 to 0x97000000 ");
    res = sd_copy((uint8_t *)0x97000000UL, pbit2->first_lba, pbit2->last_lba - pbit2->first_lba + 1);
