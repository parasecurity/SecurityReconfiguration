...
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS12 } [get_ports {btn_down}]; #IO_0_15 Sch=btnd
...
set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS12 } [get_ports {btn_up}]; #IO_L24N_T3_17 Sch=btnu
