...
add_cells_to_pblock [get_pblocks pblock_dcache] [get_cells -quiet [list i_ariane/i_cva6/i_cache_subsystem/dcache]]
resize_pblock [get_pblocks pblock_dcache] -add {SLICE_X4Y304:SLICE_X57Y347}
resize_pblock [get_pblocks pblock_dcache] -add {DSP48_X0Y122:DSP48_X2Y137}
resize_pblock [get_pblocks pblock_dcache] -add {RAMB18_X0Y122:RAMB18_X2Y137}
resize_pblock [get_pblocks pblock_dcache] -add {RAMB36_X0Y61:RAMB36_X2Y68}
set_property RESET_AFTER_RECONFIG true [get_pblocks pblock_dcache]
set_property SNAPPING_MODE ON [get_pblocks pblock_dcache]
