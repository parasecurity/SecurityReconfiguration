...
HD_PWD='/home/alex/SecurityReconfiguration/dfx_genesys/dfx_genesys.runs/ila_vs_count_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_vs_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_vs_count.tcl
