...
## Clock Signal
#create_clock -name clk_p -period 5 [get_ports clk_p] #Creating a 200Mhz differential clock
...
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets i_clk_wiz/inst/clk_in1_clk_wiz_0]

## Buttons
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS12 } [get_ports { btnc }]; #IO_25_17 Sch=btnc
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS12} [get_ports btn_down]
...
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS12} [get_ports btn_up]
set_property -dict {PACKAGE_PIN R19 IOSTANDARD LVCMOS33} [get_ports p_resetn]
...
set_property -dict {PACKAGE_PIN R29 IOSTANDARD LVCMOS33} [get_ports sd_spi_mosi]
set_property -dict {PACKAGE_PIN R26 IOSTANDARD LVCMOS33} [get_ports sd_spi_miso]
...
set_property -dict {PACKAGE_PIN T30 IOSTANDARD LVCMOS33} [get_ports sd_spi_ssn]
set_property -dict {PACKAGE_PIN AE24 IOSTANDARD LVCMOS33} [get_ports sdcard_pwr_n]
set_property -dict {PACKAGE_PIN R28 IOSTANDARD LVCMOS33} [get_ports sd_spi_sck]
...
resize_pblock [get_pblocks pblock_counter] -add {SLICE_X10Y152:SLICE_X23Y183}
resize_pblock [get_pblocks pblock_counter] -add {DSP48_X0Y62:DSP48_X1Y71}
resize_pblock [get_pblocks pblock_counter] -add {RAMB18_X1Y62:RAMB18_X1Y71}
resize_pblock [get_pblocks pblock_counter] -add {RAMB36_X1Y31:RAMB36_X1Y35}
set_property RESET_AFTER_RECONFIG true [get_pblocks pblock_counter]
set_property SNAPPING_MODE ON [get_pblocks pblock_counter]
